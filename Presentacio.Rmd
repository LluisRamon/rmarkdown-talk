...
* __markdown__: escritura fácil de paginas web
* __Sweave__: generar informes LaTeX y cálculos en R
* __knitr__: actualización de Sweave más general 
* __pandoc__: transformar entre markup languages
* __rmarkdown__: generar documentos con markdown y cálculos en R
...
<div class="columns-2">
<img src="images/crear_rmarkdown.png" alt="output_option" height="400" hspace="40">
<img src="images/documents_rmarkdown.png" alt="output_option" height="400">
</div>
...
<img src="images/rmarkdown_reference_guide_60.png" alt="output_option" height="400" hspace="40">
</a>
<img src="images/rstudio_quick_reference.png" alt="output_option" height="350">
...
![Foo2](images/documents_rmarkdown.png)
...
![Foo3](images/more_options_documents.png)

# Corrector ortográfico

<div class="columns-2">
<img src = "images/corrector_rmarkdown.png" alt = "output_option" height="200" hspace="40">
<img src = "images/escoger_idioma_corrector.png" alt = "output_option" height="400">
</div>
...
* How a Chunk looks like? 

<img src="images/img2.tiff" height="200">
...
* comment('##'; character): com mostra el codi.
...
![Foo3](images/presentacions_rmarkdown.png)
...
<pre>
<code>```{r results = 'asis', warning = FALSE}
library(dygraphs)
...
```{r, eval = TRUE}
library(xtable)
xmtcars <- xtable(head(iris), caption = "5 primeros valores de iris")
print.xtable(xmtcars, type = "html")
```
...
```{r}
library(knitr)
library(printr) # A github
head(iris)
```

# Añadiendo opciones de LaTeX

* Directamente al codigo
...
<img src="images/latex.png" alt="output_option" height="50"> 
...
<img src="images/img4.png" alt="output_option" height="400"> 

<img src="images/img5.png" alt="output_option" height="130"> 

Recordar, Tools / Global Options:

<img src="images/img3.tiff" alt="output_option" height="400"> 
...
<img src="images/img6.png" alt="output_option" height="400"> 

<img src="images/img7.png" alt="output_option" height="400"> 
...
<img src="images/img8.png" alt="output_option" height="150"> 
...
* Repetir el ejemplo del ejercicio X.
...
<img src="images/gif1.gif" alt="output_option" height="200">
...
<img src="images/img11.png" alt="output_option" align="middle" height="1500"> 
